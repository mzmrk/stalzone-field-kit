...
- [Calculation model](calculation-model.md) owns stat semantics, formula order,
  rarity and quality behavior, exposure protection, warning thresholds, and
...
| Stat formulas, keys, quality tiers, protection, warnings, or bonus handling | [Calculation model](calculation-model.md) |
